...
return Util.local_plugin("TheNoeTrevino/atlas.nvim", "~/projects/atlas.nvim", {
  ...
  ---@type AtlasConfig
  opts = {
    -- Authentication and endpoints live here. `pulls` and `issues` below keep
    -- only the domain-scoped `views`, `bookmarks`, and `project_config`.
    ...
    keymaps = {
      ui = {
        first_item = "gg",
        last_item = "G",
        -- The diff explorer opens the file under the cursor with this key.
        select = { "<CR>", "l" },
        submit = "<C-s>",
    ...
    pulls = {
      ...
      repo_config = {
        ...
        paths = {
          ...
          ["TNTrevino/tremolo"] = "~/projects/tremolo/main",
        },
      },
      ...
      github = {
        ...
        views = {
          ...
          { name = "Assigned", key = "A", layout = "compact", search = "is:pr assignee:@me archived:false" },
        ...
        views = {
          {
            ...
            key = "I",
            layout = "compact",
            search = "repo:ssglimited/icris",
          },
          {
            name = "NMCRIS",
            key = "N",
            layout = "compact",
            search = "repo:ssglimited/nmcris",
          },
        },
      },
    },
